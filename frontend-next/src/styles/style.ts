const styles = {
  ...
  heading2:
    " text-gray-900 font-semibold xs:text-[40px] text-[30px] text-gray-900 xs:leading-[76.8px] leading-[66.8px]",
  heading4:
    "text-xl font-semibold text-gray-500 justify-center text-center items-center md:text-4xl ",
  heading5:
    "text-xl font-semibold text-gray-500 justify-center text-center items-center sm:text-l",
  paragraph: " font-normal text-dimWhite text-[18px] leading-[30.8px]",

  contactForm:
    "outline-none bg-slate-400/10 rounded-sm border-b w-full px-6 py-4 text-gray-300 placeholder-gray-500 focus:text-[#895785] hover:border-[#653565]",
